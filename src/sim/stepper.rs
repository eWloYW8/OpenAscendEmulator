...
use crate::sim::c310::vector_queue::C310VfQueueInstruction;
...
mod tests {
    ...
    use crate::isa::flow::{BufferEncoding, BufferOperation, C310BufferStep};
        ...
        for (architecture, pc, word) in [
            ...
            assert!(matches!(
                ...
                Err(ScalarInstructionError::Memory(
                    crate::sim::machine::ScalarMemoryExecutionError::Backend(_)
                ))
            ));
            assert_eq!(stepper, before);
        }
