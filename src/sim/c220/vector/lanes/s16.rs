...
pub(in crate::sim::c220::vector) struct C220S16LaneOutcome {
    pub active: bool,
    pub bits: u32,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::sim::c220::vector) struct C220S16ValueInputs {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::sim::c220::vector) struct C220S16WidenInputs {
    pub hint: C220VecArithmeticHint,
    pub control: C220VectorControl,
    pub addresses: C220VectorAddresses,
    pub repeat_index: usize,
...
pub(in crate::sim::c220::vector) fn evaluate_c220_s16_widen_repeat_from_bytes(
    ...
    for lane_index in 0..64 {
        ...
        stores.push(C220VectorStore {
            ...
            width_bytes: 4,
            data: crate::sim::c220::vector::access::store_data(value.to_le_bytes()),
        });
        lanes.push(C220S16LaneOutcome {
            active,
            bits: value as u32,
...
pub(in crate::sim::c220::vector) fn evaluate_c220_s16_repeat_from_bytes(
