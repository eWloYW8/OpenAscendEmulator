use crate::isa::c220::vector::ternary::{
    C220TernaryInstruction, C220TernaryOperation, C220TernaryWidth,
};
use crate::memory::ub::UbMemory;
use crate::numeric::fp32::{Fp32ValueStatus, Fp32VectorOperation, evaluate_fp32_value};
use crate::sim::c220::memory::C220UbBank;
use crate::sim::c220::numeric::fp16::{C220Fp16Mode, C220Fp16Status, evaluate_c220_fp16_relu};

use crate::sim::c220::vector::lanes::fma::{
    evaluate_c220_f16_mla, evaluate_c220_fp32_mla, evaluate_c220_mixed_mla,
};
...
fn evaluate_f16(
    ...
    let bits = if operation == C220TernaryOperation::MultiplyAddRelu {
        ...
        status = status.merge(relu.status);
        relu.bits
    } else {
        sum
    };
