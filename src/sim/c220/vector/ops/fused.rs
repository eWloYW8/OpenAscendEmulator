use crate::isa::c220::vector::conversion::{C220ConversionRound, C220ConversionType};
use crate::isa::c220::vector::fused::{C220FusedFormat, C220FusedInstruction, C220FusedOperation};
    ...
    match issue.instruction.format {
        ...
        C220FusedFormat::F16ToS8 | C220FusedFormat::F16ToU8 => {
            ...
            let (bits, fp_status) = if issue.instruction.operation == C220FusedOperation::Multiply {
                ...
                (relu.bits, arithmetic.status.merge(relu.status))
            };
