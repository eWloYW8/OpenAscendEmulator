...
use crate::isa::c220::mte1::{C220_LOAD_2D_BLOCK_BYTES, C220Load2dDestination, C220Load2dTransfer};

pub const C220_MTE1_COMMAND_TICKS: u64 = 1;
pub const C220_MTE1_L1_READ_TICKS: u64 = 8;
pub const C220_MTE1_DESTINATION_PROGRESS_TICKS: u64 = 1;
pub const C220_MTE1_RETIRE_TICKS: u64 = 1;
pub const C220_MTE1_DESTINATION_QUEUE_DEPTH: usize = 2;
pub const C220_MTE1_ISSUE_QUEUE_DEPTH: usize = 32;
pub const C220_MTE1_MAX_OUTSTANDING: usize = 31;
pub const C220_MTE1_L1_TO_L0A_BYTES_PER_TICK: u64 = 256;
pub const C220_MTE1_L1_TO_L0B_BYTES_PER_TICK: u64 = 128;
...
impl C220Mte1TimingRules {
    pub const fn dav2201() -> Self {
        Self {
            ...
            l1_to_l0a_bytes_per_tick: nonzero(C220_MTE1_L1_TO_L0A_BYTES_PER_TICK),
            l1_to_l0b_bytes_per_tick: nonzero(C220_MTE1_L1_TO_L0B_BYTES_PER_TICK),
        }
    }
}
...
pub enum C220Mte1TimingError {
    #[error("C220 MTE1 transfer bandwidth is not configured")]
    Unconfigured,
...
pub struct C220TimedMte1Lane {
    rules: Option<C220Mte1TimingRules>,
    next_issue_tick: u64,
...
impl Default for C220TimedMte1Lane {
    fn default() -> Self {
        Self {
            rules: Some(C220Mte1TimingRules::default()),
            next_issue_tick: 0,
            l0a: C220Mte1RouteState::default(),
            l0b: C220Mte1RouteState::default(),
            pending_retirements: VecDeque::new(),
            last_retirements: Vec::new(),
            unsignaled_retire_tick: None,
            events: BTreeMap::new(),
        }
    }
}
...
impl C220TimedMte1Lane {
    ...
    pub const fn rules(&self) -> Option<C220Mte1TimingRules> {
        self.rules
    }
    ...
    pub fn preview_issue(
        ...
        let rules = self.rules.ok_or(C220Mte1TimingError::Unconfigured)?;
        ...
        let service_ticks = ceil_div(u64::from(C220_LOAD_2D_BLOCK_BYTES), rate.get());
...
const fn nonzero(value: u64) -> NonZeroU64 {
    match NonZeroU64::new(value) {
        Some(value) => value,
        None => panic!("C220 timing constants must be non-zero"),
    }
}
