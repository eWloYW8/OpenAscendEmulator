    ...
    fn request_routes_and_descriptor_widths() {
        for (output, length, xt, left, right, route, count) in [
            (
                ...
                0,
                0,
                C220DmaUopRoute::MovPadBatch { burst_bytes: 17 },
                1,
            ),
            (
                false,
                ...
                0,
                0,
                C220DmaUopRoute::MovPad { padding_bytes: 0 },
                2,
            ),
            (
                false,
                ...
                0,
                0,
                C220DmaUopRoute::MovPadDestinationGapCollapse { burst_bytes: 64 },
                1,
            ),
            (
                false,
                ...
                1,
                1,
                C220DmaUopRoute::MovPad { padding_bytes: 2 },
                2,
            ),
