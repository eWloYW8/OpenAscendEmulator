...
use crate::isa::c310::vector::{
    ...
    C310_CAPTURED_SUB_VST_WORD, C310_CAPTURED_VDUPS_WORD, C310_CAPTURED_VECTOR_LOAD_BYTES,
    C310_CAPTURED_VST_WORD, C310_MASK0_SPR_INDEX, C310CapturedVectorLoadHint,
    C310ObservedMovemaskHint, C310RvecArithmeticHint, C310RvecArithmeticOperation,
    C310RvecMovpHint, C310RvecVstiHint,
};
...
use crate::isa::c310::vector::{
    ...
    C310_CAPTURED_VLDI_V1_WORD, C310_MASK1_SPR_INDEX,
};
