...
mod tests {
    ...
    fn ub_with_inputs_and_prior(x: &[u32; 32], y: &[u32; 32], prior: &[u32; 32]) -> UbMemory {
    ...
    fn output_words(ub: &UbMemory) -> Vec<u32> {
