...
impl C220VectorControl {
    pub const fn decode_binary(control: u64) -> Self {
        Self {
    ...
    pub const fn decode_unary(control: u64) -> Self {
        Self {
            encoded_repeat_count: (control >> 56) as u8,
...
impl C220MovevControl {
    pub const fn decode(control: u64) -> Self {
        Self {
            encoded_repeat_count: (control >> 56) as u8,
            destination_block_stride: (control & 0xffff) as u16,
            destination_repeat_stride: (((control >> 32) & 0xff) | (((control >> 52) & 0xf) << 8))
